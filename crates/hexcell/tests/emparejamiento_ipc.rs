...
async fn ejecutar_emparejamiento_codigo_de_vinculacion_exitoso() {
    ...
    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"codigo_emparejamiento\",\"metodo\":\"codigo_de_vinculacion\",\"valor\":\"ABC1-2345\",\"expira_en_ms\":0}",
        )
        .await;

    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"acuse_emparejamiento\",\"resultado\":\"completado\",\"motivo\":\"\"}",
        )
        .await;
...
async fn ejecutar_emparejamiento_qr_rotativo_exitoso() {
    ...
    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"codigo_emparejamiento\",\"metodo\":\"qr\",\"valor\":\"qr_code_frame_1\",\"expira_en_ms\":1000}",
        )
        .await;
    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"codigo_emparejamiento\",\"metodo\":\"qr\",\"valor\":\"qr_code_frame_2\",\"expira_en_ms\":2000}",
        )
        .await;
...
async fn ordenar_emparejamiento_ipc_expirado() {
    ...
    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"acuse_emparejamiento\",\"resultado\":\"expirado\",\"motivo\":\"\"}",
        )
        .await;
...
async fn ordenar_emparejamiento_ipc_fallido_con_motivo() {
    ...
    sidecar
        .enviar_linea(
            "{\"version\":6,\"tipo\":\"acuse_emparejamiento\",\"resultado\":\"fallido\",\"motivo\":\"sesion cerrada por usuario remoto\"}",
        )
        .await;
