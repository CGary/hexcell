...
async fn ordenar_respaldo_sqlstore_ipc_exitoso() {
    ...
    let acuse = format!(
        "{{\"version\":6,\"tipo\":\"acuse_respaldo_sqlstore\",\"identificador_de_ronda\":\"ronda-ipc-1\",\"resultado\":\"completado\",\"ruta_de_la_copia\":\"{}\",\"bytes\":4096,\"motivo\":\"\"}}",
...
async fn ordenar_respaldo_sqlstore_ipc_fallido() {
    ...
    let acuse = "{\"version\":6,\"tipo\":\"acuse_respaldo_sqlstore\",\"identificador_de_ronda\":\"ronda-ipc-fallo\",\"resultado\":\"fallido\",\"ruta_de_la_copia\":\"\",\"bytes\":0,\"motivo\":\"error al verificar integridad de la copia\"}";
    sidecar.enviar_linea(acuse).await;
