...
registrado en `docs/bitacora-de-descartes.md` como **D-52**, en el mismo commit que este
ADR.
...
* `docs/bitacora-de-descartes.md`, **D-52** (descarte de `clap`, `argh`, `pico-args` y `structopt`).
