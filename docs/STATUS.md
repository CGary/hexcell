...
* **Cobertura del PRD para alertas/observabilidad (tarea 20 de A-6), configuración por archivos (tarea 22) y reporte de tokens por cliente (tarea 23): ¿FR nueva o alcance operativo fuera del PRD?** (2026-09-10). Ninguna de esas tres tareas traza a un FR/NFR del PRD; decidir si se registra una FR nueva o se declaran alcance operativo fuera del PRD bloquea su trazabilidad. — *Etapa A-6, tareas 20, 22 y 23.*
